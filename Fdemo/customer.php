...
<!-- Home start section -->
    <div class="home-content" id="#home">
        ...
        <div class="text-content-home">
            ...
            <button class="home-shop-btn btn" onclick="goProduct()" >Shop Now</button>
        </div> 
    </div>
<!-- Home section end  -->
    ...
    <div class="features-container" id="#features">
        ...
        <div class="features-container-inner">
            <div class="features">
                ...
                <button class="features-btn btn" onclick="gofeature()">Read More</button>
            </div>
            <div class="features">
...
<div class="category-container">
    ...
    <div class="category-container-inner">
        <div class="category">
            ...
            <p>Upto 45% off</p>
            <button class="category-btn btn" onclick="goCategory()">Read More</button>
        </div>
        <div class="category">
